    ...
    public class vwCfdiTransaccionesDeVenta : SqlClientEntity
	{
		...
		protected class Parameters
		{
			...
			public static SqlParameter Isocurrc
			{
				get
				{
					return new SqlParameter("@Isocurrc", SqlDbType.VarChar, 15);
				}
			}
		...
		{  
			...
			static public string ToPropertyName(string columnName)
			{
				if(ht == null)
				{
					...
					ht[EstadoContabilizado] = vwCfdiTransaccionesDeVenta.PropertyNames.EstadoContabilizado;
					ht[Soptype] = vwCfdiTransaccionesDeVenta.PropertyNames.Soptype;
					ht[Docid] = vwCfdiTransaccionesDeVenta.PropertyNames.Docid;
					ht[Sopnumbe] = vwCfdiTransaccionesDeVenta.PropertyNames.Sopnumbe;
					ht[Fechahora] = vwCfdiTransaccionesDeVenta.PropertyNames.Fechahora;
					ht[CUSTNMBR] = vwCfdiTransaccionesDeVenta.PropertyNames.CUSTNMBR;
					...
					ht[Contrasenia_clave] = vwCfdiTransaccionesDeVenta.PropertyNames.Contrasenia_clave;
					ht[Ruta_certificadoPac] = vwCfdiTransaccionesDeVenta.PropertyNames.Ruta_certificadoPac;
					ht[Ruta_clavePac] = vwCfdiTransaccionesDeVenta.PropertyNames.Ruta_clavePac;
					ht[Contrasenia_clavePac] = vwCfdiTransaccionesDeVenta.PropertyNames.Contrasenia_clavePac;
		...
		{  
			...
			static public string ToColumnName(string propertyName)
			{
				if(ht == null)
				{
					...
					ht[EstadoContabilizado] = vwCfdiTransaccionesDeVenta.ColumnNames.EstadoContabilizado;
					ht[Soptype] = vwCfdiTransaccionesDeVenta.ColumnNames.Soptype;
					ht[Docid] = vwCfdiTransaccionesDeVenta.ColumnNames.Docid;
					ht[Sopnumbe] = vwCfdiTransaccionesDeVenta.ColumnNames.Sopnumbe;
					ht[Fechahora] = vwCfdiTransaccionesDeVenta.ColumnNames.Fechahora;
					ht[CUSTNMBR] = vwCfdiTransaccionesDeVenta.ColumnNames.CUSTNMBR;
					...
					ht[Contrasenia_clave] = vwCfdiTransaccionesDeVenta.ColumnNames.Contrasenia_clave;
					ht[Ruta_certificadoPac] = vwCfdiTransaccionesDeVenta.ColumnNames.Ruta_certificadoPac;
					ht[Ruta_clavePac] = vwCfdiTransaccionesDeVenta.ColumnNames.Ruta_clavePac;
					ht[Contrasenia_clavePac] = vwCfdiTransaccionesDeVenta.ColumnNames.Contrasenia_clavePac;
